...
def main(command, folder, move_imported_to_folder, continue_on_error, db_username, db_password, db_hostname, db_port, db_database, db_schema, consumer_key, consumer_secret, access_token, access_secret, save_data_mode,
