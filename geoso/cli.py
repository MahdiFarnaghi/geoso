...
@click.option('--db_port', default='', help='Postgres database port', required=True)
@click.option('--db_database', default='', help='Postgres database name', required=True)
@click.option('--db_schema', default='public', help='Postgres database schema')
...
@main.command()
@click.pass_context
@click.option('--consumer_key', default=None, help='Twitter consumer key', required=True)
@click.option('--consumer_secret', default=None, help='Twitter consumer secret', required=True)
@click.option('--access_token', default=None, help='Twitter access token', required=True)
@click.option('--access_secret', default=None, help='Twitter access secret', required=True)
@click.option('--save_data_mode', default='FILE', type=click.Choice(['FILE', 'DB'], case_sensitive=False), help='Save data mode. Possible values: FILE (to save the outputs as JSONL files) and DB (to save the data in a PostgreSQL database)')
@click.option('--tweets_output_folder', default=None, help='The output folder to save JSONL files. Required if save_date_mode is set to FILE.', type=click.Path())
...
@click.option('--db_port', default='', help='Postgres database port. Required if save_date_mode is set to DB.')
@click.option('--db_database', default='', help='Postgres database name. Required if save_date_mode is set to DB.')
@click.option('--db_schema', default='public', help='Postgres database schema. Required if save_date_mode is set to DB.')
